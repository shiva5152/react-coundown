...
const Hero = () => {
  ...
  return (
    <div id="hero" className="w-full relative overflow-hidden">
      ...
      <section className="hero relative w-full pt-[40px] vsm:pt-[80px] xl:pt-[90px] flex 2xl:justify-between flex-col gap-[60px] xl:gap-0 items-center xl:items-start xl:flex-row px-[16px] vsm:px-[20px] xmd:px-[50px] xl:pl-[80px]">
        <div className="z-[19] w-fit xl:w-[65%] 2xl:w-fit">
          ...
          <div className="sponsors hidden mt-[32px] md:flex flex-col items-center xl:block">
            ...
            <div className="w-full flex items-center justify-center xl:justify-start flex-wrap gap-x-[20px] gap-y-[15px]">
              <img src={layerzeroImg} alt="sponsor" />
        ...
        <div className="w-[90%] md:w-[45%] 2xl:w-fit mt-[-130px] xl:mt-[-200px] xxl:mt-[-250px] ml-[-80px] xl:ml-[-100px] 2xl:ml-0">
