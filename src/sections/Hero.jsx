...
const Hero = () => {
  ...
  return (
    <div id="hero" className="w-full relative overflow-hidden">
      ...
      <div className="block 2xl:hidden absolute top-[70%] left-0 w-full h-fit">
      ...
      <section className="hero relative w-full pt-[40px] vsm:pt-[80px] xl:pt-[90px] flex flex-col gap-[60px] xl:gap-0 items-center xl:items-start xl:flex-row px-[16px] vsm:px-[20px] xmd:px-[50px] xl:pl-[80px]">
        ...
        <div className="w-[90%] md:w-[45%] mt-[-130px] xl:mt-[-200px] xxl:mt-[-250px] ml-[-80px] xl:ml-[-100px]">
