...
const Features2 = () => {
  return (
    <section
      id="features2"
      className="features2 w-full pt-[62px] xl:pt-[100px] pb-[30px] text-white"
    >
      ...
      <div className="hidden max-w-[1350px] mx-auto relative mt-[50px] xl:mt-[10px] xl:flex flex-col xl:flex-row gap-[20px] xl:gap-0 justify-center items-center">
