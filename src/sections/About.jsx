...
const About = () => {
  return (
    <section
      id="about"
      className="about relative w-full h-fit overflow-hidden pt-[30px] vsm:pt-[164px] pb-[122px] px-[16px] vsm:px-[50px] xmd:px-[80px] text-white"
    >
      <div className="sponsors mt-[32px] mb-[93px] flex md:hidden flex-col items-center">
        ...
        <div className="w-full flex justify-center xl:justify-start flex-wrap gap-x-[21px] gap-y-[15px]">
      ...
      <div className="about-box relative w-full h-fit mt-[50px] md:mt-[146px] flex gap-[30px] xmd:gap-0 flex-col xmd:flex-row justify-between xl:justify-center xl:gap-[50px]">
