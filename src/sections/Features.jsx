...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="features w-full max-w-[1900px] mx-auto h-fit pt-[31px] pb-[56px] px-[16px] vsm:px-0 text-white"
    >
      ...
      <div className="w-full vsm:w-[80%] mx-auto h-fit xl:h-[855px] mt-[25px] relative flex flex-col items-center gap-[30px] xl:block">
        ...
        <div className="featureBox xl:absolute top-[30%] right-0">
          ...
          >
            Earn more with Flexbot. Get 50% of the net fees generated back in
